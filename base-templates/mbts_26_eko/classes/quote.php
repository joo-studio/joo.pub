...
if ( empty( $comments ) || $comments == 'Project details*') {
...
$e_subject = "Quote request from: " . $name;
...
$msg  = "Client name: $name" . PHP_EOL;
$msg .= "Business type: $businesstype" . PHP_EOL;
$msg .= "Email: $email" . PHP_EOL;
$msg .= "Website: $website" . PHP_EOL;
$msg .= "Preferred contact method: $contactOptions" . PHP_EOL . PHP_EOL;
$msg .= "Project type: $projectOptions" . PHP_EOL;
$msg .= "Budget: $budgetOptions" . PHP_EOL;
$msg .= "Project details: $comments";
