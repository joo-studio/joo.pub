...
(function(window, document, Math) {
    ...
    var utils = (function() {
        ...
        me.extend(me.ease = {}, { quadratic: { style: "cubic-bezier(0.25, 0.46, 0.45, 0.94)", fn: function(k) {
                    return k * (2 - k) } }, circular: { style: "cubic-bezier(0.1, 0.57, 0.1, 1)", fn: function(k) {
                    return Math.sqrt(1 - (--k * k)) } }, back: { style: "cubic-bezier(0.175, 0.885, 0.32, 1.275)", fn: function(k) {
                    var b = 4;
                    return (k = k - 1) * k * ((b + 1) * k + b) + 1 } }, bounce: { style: "", fn: function(k) {
                    if ((k /= 1) < (1 / 2.75)) {
                        ...
                        if (k < (2 / 2.75)) {
                            ...
                            if (k < (2.5 / 2.75)) {
                                ...
                                return 7.5625 * (k -= (2.625 / 2.75)) * k + 0.984375 } } } } }, elastic: { style: "", fn: function(k) {
                    var f = 0.22,
                        e = 0.4;
                    if (k === 0) {
                        return 0 }
        ...
        me.click = function(e) {
            var target = e.target,
                ev;
            if (!(/(SELECT|INPUT|TEXTAREA)/i).test(target.tagName)) { ev = document.createEvent("MouseEvents");
    ...
    IScroll.prototype = {
        ...
        _start: function(e) { console.log(0);
        ...
        _move: function(e) {
            ...
            if (this.directionLocked == "h") {
                if (this.options.eventPassthrough == "vertical") { e.preventDefault() } else {
                    if (this.options.eventPassthrough == "horizontal") { this.initiated = false;
                        return } }
                deltaY = 0 } else {
        ...
        _initWheel: function() { utils.addEvent(this.wrapper, "wheel", this);
            ...
            this.on("destroy", function() { utils.removeEvent(this.wrapper, "wheel", this);
        ...
        _wheel: function(e) {
            ...
            this.wheelTimeout = setTimeout(function() { that._execEvent("scrollEnd");
        ...
        handleEvent: function(e) {
            switch (e.type) {
                ...
                case "keydown":
                    ...
                    break;
                case "click":
                    if (!e._constructed) { e.preventDefault();
                        e.stopPropagation() }
                    break } }
    };
    ...
    function Indicator(scroller, options) { this.wrapper = typeof options.el == "string" ? document.querySelector(options.el) : options.el;
    ...
    Indicator.prototype = {
        ...
        transitionTime: function(time) { time = time || 0;
